...
public class JSWaiter {
    ...
    //Get the driver
    public static void setDriver(WebDriver driver) throws IOException {
        jsWaitDriver = driver;
    ...
    public static void waitForJQueryLoad() throws IOException {
        setDriver(getDriver());
        try {
    ...
    public static void waitUntilJSReady() throws IOException {
        setDriver(getDriver());
        try {
